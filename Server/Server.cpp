...
int main()
{
    ...
    while (true)
    {
        ...
        if (iResult > 0) {
            ...
            ////if (it != str.end()) number = stof(str.c_str() + (it - str.begin()));
            //number = stof(str);
            //cout << number << endl;
            //for (int i = 0; i < 256; i++)
            //{
        ...
        else if (message == "how's goin'?") {
            answer == "okay";
        }
        else if (message == "wanna joke?") {
            answer == "yeah";
        }
        else if (message == "what camel has 3 hump?") {
            answer == "so what?";
        }
        else if (message == "pregenant") {
            answer == "AHAHAHAHAHAH";
        }
        else {
        ...
        //cout << "ответ от сервера: "; cin.getline(answer, 200);
